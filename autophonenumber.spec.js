...
test("create job and payment process full flow with auto generted phone number", async ({
  browser,
}) => {
  ...
  await page.waitForSelector("//a[@data-target='#add_new_service']", { state: 'visible' });
  await page
